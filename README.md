...
* Активность пользователей по платформам OS, Android, Windows и т.д.;
...
Замеряя, сколько игрок потратил в среднем в первый день, второй, вы можете сформировать накопительный **ARPU** в начале кривой.
